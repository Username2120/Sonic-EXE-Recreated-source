//taken stright from 2.5 source, basically if it had to do with freeplay then its was.
//if you wanna know why check the freeplay state
//nvm i got rid of them AHHHHHHHHHHHHHHH
package;
