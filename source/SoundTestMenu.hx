...
class SoundTestMenu extends MusicBeatState
{
    ...
    override function create()
        {
			Discord.DiscordClient.changePresence('In the Sound Test Menu', null);
	...
	function doTheThing(first:Int, second:Int) 
	{
		if (first == 12 && second == 25)
		{
			...
			PlayState.SONG = Song.loadFromJson('endless-exe', 'endless');
			...
			{
				woahmanstopspammin = false;
				PlayState.SONG = Song.loadFromJson('cycles-exe', 'cycles');
				PlayState.isStoryMode = false;
				PlayState.storyDifficulty = 2;
				PlayState.storyWeek = 1;
				FlxTransitionableState.skipNextTransIn = true;
			...
			else if (first == 31 && second == 13)
			{
				...
				PlayState.SONG = Song.loadFromJson('faker-exe', 'faker');
				PlayState.isStoryMode = false;
				PlayState.storyDifficulty = 2;
				FlxTransitionableState.skipNextTransIn = true;
				FlxTransitionableState.skipNextTransOut = true;
			...
			else if (first == 66 && second == 30)
			{
				woahmanstopspammin = false;
				PlayState.SONG = Song.loadFromJson('personel-exe', 'personel');
				PlayState.isStoryMode = false;
				PlayState.storyDifficulty = 2;
				PlayState.storyWeek = 1;
				FlxTransitionableState.skipNextTransIn = true;
			...
			{
				woahmanstopspammin = false;
				PlayState.SONG = Song.loadFromJson('fight-or-flight-exe', 'flight-or-flight');
				PlayState.isStoryMode = false;
				PlayState.storyDifficulty = 2;
				PlayState.storyWeek = 1;
				FlxTransitionableState.skipNextTransIn = true;
		...
		else if (first == 13 && second == 0)
			{
				woahmanstopspammin = false;
				PlayState.SONG = Song.loadFromJson('prey-exe', 'prey');
				PlayState.isStoryMode = false;
				PlayState.storyDifficulty = 2;
				PlayState.storyWeek = 1;
				FlxTransitionableState.skipNextTransIn = true;
			...
			{
				woahmanstopspammin = false;
				PlayState.SONG = Song.loadFromJson('chaos-exe', 'chaos');
				PlayState.isStoryMode = false;
				PlayState.storyDifficulty = 2;
				PlayState.storyWeek = 1;
				FlxTransitionableState.skipNextTransIn = true;
