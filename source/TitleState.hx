...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		bg.animation.addByPrefix('background', 'TitleMenuSSBG', 16, true);
		...
		//another shitty way to do this idk why i keep doing things like this
		logoStat = new FlxSprite(0).loadGraphic(Paths.image('logo'));
		logoStat.setGraphicSize(Std.int(bg.width * 2));
		logoStat.screenCenter();
		logoStat.antialiasing = ClientPrefs.globalAntialiasing;
		add(logoStat);
